...
class MainGUI():
    ...
    def setup_imgui_style(self):
        ...
        imgui.style.set_color(imgui.Col_.modal_window_dim_bg, imgui.ImVec4(0, 0, 0, 0.5))
        imgui.style.set_color(imgui.Col_.table_border_strong, imgui.ImVec4(0, 0, 0, 0))
        self.refresh_styles()
    ...
    def style_imgui_functions(self):
        ...
        def checkbox(label: str, state: bool, frame_size: Tuple=None, do_vertical_align=True):
            if state:
                imgui.push_style_color(imgui.Col_.frame_bg_hovered, imgui.style.get_color(imgui.Col_.button_hovered))
        ...
        def combo(*args, **kwargs):
            imgui.push_style_color(imgui.Col_.button, imgui.style.get_color(imgui.Col_.button_hovered))
    ...
    def refresh_styles(self):
        imgui.style.set_color(imgui.Col_.check_mark, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.tab_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.slider_grab, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.tab_hovered, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.button_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.header_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.nav_highlight, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.plot_histogram, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.button_hovered, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.header_hovered, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.separator_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.separator_hovered, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.resize_grip_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.resize_grip_hovered, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.tab_unfocused_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.scrollbar_grab_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.frame_bg_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.title_bg_active, imgui.ImVec4(*globals.settings.style_accent))
        imgui.style.set_color(imgui.Col_.text_selected_bg, imgui.ImVec4(*globals.settings.style_accent))
        
        imgui.style.set_color(imgui.Col_.tab, imgui.ImVec4(*globals.settings.style_accent[0:3], 0.25))
        imgui.style.set_color(imgui.Col_.resize_grip, imgui.ImVec4(*globals.settings.style_accent[0:3], 0.25))
        imgui.style.set_color(imgui.Col_.tab_unfocused, imgui.ImVec4(*globals.settings.style_accent[0:3], 0.25))
        imgui.style.set_color(imgui.Col_.frame_bg_hovered, imgui.ImVec4(*globals.settings.style_accent[0:3], 0.25))
        
        imgui.style.set_color(imgui.Col_.table_header_bg, imgui.ImVec4(*globals.settings.style_alt_bg))
        imgui.style.set_color(imgui.Col_.table_row_bg_alt, imgui.ImVec4(*globals.settings.style_alt_bg))
        
        imgui.style.set_color(imgui.Col_.button, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.header, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.frame_bg, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.child_bg, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.popup_bg, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.title_bg, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.window_bg, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.slider_grab_active, imgui.ImVec4(*globals.settings.style_bg))
        imgui.style.set_color(imgui.Col_.scrollbar_bg, imgui.ImVec4(*globals.settings.style_bg))
        
        imgui.style.set_color(imgui.Col_.border, imgui.ImVec4(*globals.settings.style_border))
        imgui.style.set_color(imgui.Col_.separator, imgui.ImVec4(*globals.settings.style_border))
        ...
        imgui.style.set_color(imgui.Col_.text, imgui.ImVec4(*globals.settings.style_text))

        imgui.style.set_color(imgui.Col_.text_disabled, imgui.ImVec4(*globals.settings.style_text_dim))
